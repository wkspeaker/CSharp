...
using LangrisserTools.TimeCalculatorForGuild.Models;
using LangrisserTools.TimeCalculatorForGuild.Services;

namespace LangrisserTools.TimeCalculatorForGuild.ViewModels
{
